...
namespace NuFetchLib {
    public class NuFetchOption {
        ...
        [Option('f', "fetchOnly", DefaultValue = false, HelpText = "Flag denoting if the downloader should just fetch the packages, without downloading them. The results will be available in packages_$PACKAGE_NAME_$VERSION.txt")]
